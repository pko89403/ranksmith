...
- Zero-shot listwise, pairwise PRP, setwise heapsort, tournament, uncertainty-aware adaptive reranking을 지원한다.
- `rankgpt_sliding_window`, `prp_sliding_k`, `setwise_heapsort`, `tourrank_r`, `acurank` algorithm을 지원한다.
- indexing은 하지 않는다.
...
- `ListwiseStrategy.algorithm`: `rankgpt_sliding_window`
- `window_size`: `20`
- `stride`: `10`
- `max_document_chars`: `4000`
- `PairwiseStrategy.algorithm`: `prp_sliding_k`
- `passes`: `10`
- `SetwiseStrategy.algorithm`: `setwise_heapsort`
- `set_size`: `3`
